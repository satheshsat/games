...
export class SnakeComponent implements OnInit {
  ...
  private tempDirection: number | undefined;
  ...
  setColors(col: number, row: number): string {
    if (this.isGameOver) {
      ...
      this.default_mode === 'obstacles' &&
      this.checkObstacles(row, col)
    ) {
