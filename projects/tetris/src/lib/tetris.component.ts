...
export class TetrisComponent implements OnInit {
  ...
  canvasNext: ElementRef<HTMLCanvasElement> | any;
  ...
  paused: boolean | any;
  gameStarted: boolean | any;
  time: { start: number; elapsed: number; level: number } | any;
  points: number | any;
  highScore: number | any;
  lines: number | any;
  level: number | any;
  moves: any = {
